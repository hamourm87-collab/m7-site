(function () {
  ...
  var strings = {
    ar: {
      ...
      galleryTitle: "المعرض",
      galleryLead: "صور من الملف العام على Google Maps وSalonati، مع رسوم مراجعة لاستكمال الشبكة. ليست معرض أعمال نهائياً.",
    ...
    en: {
      ...
      galleryLead: "Official Google Maps and Salonati listing photos, plus branded Soft UI visuals to complete the grid. Not a final portfolio.",
      ...
      gal2Alt: "Wash stations from the public Salonati listing",
      ...
      gal5Alt: "Evening styling tools — branded review visual",
      gal6Alt: "Nail polish still life — branded review visual",
